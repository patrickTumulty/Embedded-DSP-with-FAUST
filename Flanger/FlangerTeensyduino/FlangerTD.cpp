  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec0[0] = (iRec0[1] + 1);
			table[i] = std::sin((0.0245436933f * float((iRec0[0] + -1))));
			iRec0[1] = iRec0[0];
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "FlangerTD.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.1");
		m->declare("name", "FlangerTD");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("FlangerTD");
		ui_interface->addHorizontalSlider("Depth", &fHslider1, 0.5f, 0.100000001f, 1.0f, 0.100000001f);
		ui_interface->addHorizontalSlider("Fq", &fHslider2, 5.0f, 0.5f, 100.0f, 0.100000001f);
		ui_interface->addHorizontalSlider("Wet", &fHslider0, 0.5f, 0.00999999978f, 1.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (63.0f * float(fHslider1));
		float fSlow2 = (fConst0 * float(fHslider2));
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input0[i]);
			fVec0[(IOTA & 127)] = fTemp0;
			fRec1[0] = (fSlow2 + (fRec1[1] - std::floor((fSlow2 + fRec1[1]))));
			float fTemp1 = (fTemp0 + (fSlow0 * fVec0[((IOTA - int(std::min<float>(128.0f, std::max<float>(0.0f, (fSlow1 * (ftbl0mydspSIG0[int((256.0f * fRec1[0]))] + 1.0f)))))) & 127)]));
...
FlangerTD::FlangerTD() : AudioStream((fDSP = new mydsp())->getNumInputs(), new audio_block_t*[fDSP->getNumInputs()])
{
    fUI = new MapUI();
...
void FlangerTD::setParamValue(const std::string& path, float value)
{
