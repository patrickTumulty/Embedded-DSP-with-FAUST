...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "Harmonizer.dsp");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("LV", &fHslider3, 0.0f, 0.0f, -12.0f, 1.0f);
		ui_interface->addHorizontalSlider("UV1", &fHslider1, 0.0f, 0.0f, 12.0f, 1.0f);
		ui_interface->addHorizontalSlider("UV2", &fHslider2, 12.0f, 12.0f, 24.0f, 1.0f);
		ui_interface->addHorizontalSlider("Wet/Dry", &fHslider0, 0.5f, 0.00999999978f, 0.99000001f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (0.333333343f * (fSlow0 + -1.0f));
		float fSlow2 = std::pow(2.0f, (0.0833333358f * float(fHslider1)));
		float fSlow3 = std::pow(2.0f, (0.0833333358f * float(fHslider2)));
		float fSlow4 = std::pow(2.0f, (0.0833333358f * float(fHslider3)));
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input0[i]);
			fVec0[(IOTA & 2047)] = fTemp0;
			fRec0[0] = std::fmod(((fRec0[1] + 1001.0f) - fSlow2), 1000.0f);
			int iTemp1 = int(fRec0[0]);
			float fTemp2 = std::floor(fRec0[0]);
			float fTemp3 = std::min<float>((0.020833334f * fRec0[0]), 1.0f);
			float fTemp4 = (fRec0[0] + 1000.0f);
			int iTemp5 = int(fTemp4);
			float fTemp6 = std::floor(fTemp4);
			fRec1[0] = std::fmod(((fRec1[1] + 1001.0f) - fSlow3), 1000.0f);
			int iTemp7 = int(fRec1[0]);
			float fTemp8 = std::floor(fRec1[0]);
			float fTemp9 = std::min<float>((0.020833334f * fRec1[0]), 1.0f);
			float fTemp10 = (fRec1[0] + 1000.0f);
			int iTemp11 = int(fTemp10);
			float fTemp12 = std::floor(fTemp10);
			fRec2[0] = std::fmod(((fRec2[1] + 1001.0f) - fSlow4), 1000.0f);
			int iTemp13 = int(fRec2[0]);
			float fTemp14 = std::floor(fRec2[0]);
			float fTemp15 = std::min<float>((0.020833334f * fRec2[0]), 1.0f);
			float fTemp16 = (fRec2[0] + 1000.0f);
			int iTemp17 = int(fTemp16);
			float fTemp18 = std::floor(fTemp16);
			output0[i] = FAUSTFLOAT(((fSlow0 * fTemp0) + (fSlow1 * ((((((fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, iTemp1))) & 2047)] * (fTemp2 + (1.0f - fRec0[0]))) + ((fRec0[0] - fTemp2) * fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, (iTemp1 + 1)))) & 2047)])) * fTemp3) + (((fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, iTemp5))) & 2047)] * (fTemp6 + (-999.0f - fRec0[0]))) + (fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, (iTemp5 + 1)))) & 2047)] * (fRec0[0] + (1000.0f - fTemp6)))) * (1.0f - fTemp3))) + ((((fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, iTemp7))) & 2047)] * (fTemp8 + (1.0f - fRec1[0]))) + ((fRec1[0] - fTemp8) * fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, (iTemp7 + 1)))) & 2047)])) * fTemp9) + (((fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, iTemp11))) & 2047)] * (fTemp12 + (-999.0f - fRec1[0]))) + (fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, (iTemp11 + 1)))) & 2047)] * (fRec1[0] + (1000.0f - fTemp12)))) * (1.0f - fTemp9)))) + ((((fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, iTemp13))) & 2047)] * (fTemp14 + (1.0f - fRec2[0]))) + ((fRec2[0] - fTemp14) * fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, (iTemp13 + 1)))) & 2047)])) * fTemp15) + (((fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, iTemp17))) & 2047)] * (fTemp18 + (-999.0f - fRec2[0]))) + (fVec0[((IOTA - std::min<int>(1025, std::max<int>(0, (iTemp17 + 1)))) & 2047)] * (fRec2[0] + (1000.0f - fTemp18)))) * (1.0f - fTemp15)))))));
			IOTA = (IOTA + 1);
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
...
Harmonizer::Harmonizer() : AudioStream((fDSP = new mydsp())->getNumInputs(), new audio_block_t*[fDSP->getNumInputs()])
{
    fUI = new MapUI();
...
void Harmonizer::setParamValue(const std::string& path, float value)
{
